public class Macchina2 implements Runnable {
    ...
    public Macchina2(String macchina, Semaforo incrocio1, Semaforo incrocio2, Semaforo incrocio3, Semaforo incrocio4) {
