...
public class AutoPlanante extends Thread {

    private String nome;
    private int peso;
    private int velocita;
    private int lunghezzaAlettone;
    ...
    public AutoPlanante(String nome, int peso, int velocita, int lunghezzaAlettone, Podio p) {
        this.nome = nome;
        this.peso = peso;
        this.velocita = velocita;
        this.lunghezzaAlettone = lunghezzaAlettone;
        this.p = p;
    }
    ...
    private void Ostacolo() {
        ...
        if (pedana) {
            if (lunghezzaAlettone > 90) {
                velocita *= 1.02;
                System.out.println(nome + " ha aumentato la velocità sulla pedana");
            } else {
                System.out.println(nome + " ha superato la pedana senza effetti");
            }
        } else {
            velocita *= 0.95;
            if (velocita < 1) {
            ...
            System.out.println(nome + " ha rallentato a causa del dosso");
