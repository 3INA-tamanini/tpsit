public class Macchina1 implements Runnable {
    ...
    public Macchina1(String macchina, Semaforo incrocio1, Semaforo incrocio2, Semaforo incrocio3, Semaforo incrocio4) {
